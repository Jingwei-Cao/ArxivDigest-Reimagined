    ...
    async def filter_batch(
        ...
        if uncached_papers:
            ...
            for paper in uncached_papers:
                ...
                if html:
                    # Cache raw HTML on the paper object so Stage 3 can reuse it.
                    # JSONExporter only exports known paper fields, so this raw
                    # HTML will not be included in digest.json.
            ...
            logger.info(
                f"Stage 2: Successfully extracted text from "
